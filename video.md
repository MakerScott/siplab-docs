...
The recipe becomes a shot list before the model sees it. Every ingredient is listed in its measured kitchen amount. Every step is listed in order. The serving glass is named once and kept for the whole clip.
...
- Film extra prep that the recipe did not write, such as grinding beans when the ingredient is already a paste, or toasting something that is only a flavor word in the name
